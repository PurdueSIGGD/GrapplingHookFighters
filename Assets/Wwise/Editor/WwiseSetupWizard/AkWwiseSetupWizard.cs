...
For more information on a particular setting, hover your mouse over it.",
        ...
        if (GUILayout.Button("Start Installation", GUILayout.Width(200)))
        {
            ...
            else
            {
                ...
                {
                    Debug.LogError("WwiseUnity: Could not complete Wwise Unity integration installation");
                }
    ...
    public static void ShowHelp()
    {
		...
		catch(Exception e)
        {
            ...
            Debug.Log("WwiseUnity: Unable to show documentation. Please unzip WwiseUnityIntegrationHelp_en.zip manually.");
        }
    }
    ...
    public static bool DisableBuiltInAudio()
    {
    ...
    static void UninstallIntegration()
    {
        try
        {
			...
			string docPath = Path.Combine (Path.Combine (Application.dataPath, ".."), "WwiseUnityIntegrationHelp_en");
    ...
    public static void PackageDemo()
    {
        ...
        string[] dirsToExport = {
            ...
            "Assets/Wwise/Deployment",
            "Assets/Wwise/Documentation",
            "Assets/Wwise/Editor/WwiseComponents",
            "Assets/Wwise/Editor/WwiseMenu",
            "Assets/Wwise/Editor/WwiseSetupWizard",
            "Assets/Wwise/Editor/WwiseWindows",
            "Assets/Wwise/Gizmos",
            "Assets/Wwise/Tools",
            "Assets/Wwise/Version.txt",
